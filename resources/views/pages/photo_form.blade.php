...
<div class="container">
  <div class="row">
    <div class="col-12 my-4"> <a href=""><i class="fas fa-arrow-left"></i> Voltar</a> </div>
    <div class="col-12">
          ...
          <div class="p-md-3">
            <form action="">
              <div class="row">
                <div class="col-lg-6">
                  <div class="d-flex flex-column h-100">
                    <div
                      ...
                      <i class="far fa-image"></i> <br> <small> </small> </div>
                ...
                <div class="col-lg-6">
                  <div class="form-group"> <label for="text">Título</label>
                  ...
                  <div class="form-group"> <label for="text">Data</label>
                    <div class="input-group">
                      <div class="input-group-prepend">
                  ...
                  <div class="form-group"> <label for="textarea">Descrição</label> <textarea id="textarea"
                      name="textarea" cols="40" rows="5" class="form-control"
                      placeholder="Digite uma pequena descrição da imagem"></textarea> </div>
                  <div class="form-group d-flex"> <button name="submit" type="submit"
                      class="btn btn-laranja">Limpar</button> <button name="submit" type="submit"
